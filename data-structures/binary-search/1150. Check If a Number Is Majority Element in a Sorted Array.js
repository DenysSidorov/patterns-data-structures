/* Not solved in leetcode*/
function findMajorityElement(a, target){
  const range = searchRange(a, target);
  if (range[0] === -1 || range[1] === -1) {
    return false;
  }
  return ((range[1] - range[0] + 1) > a.length / 2);
}

const a = [1,5,5,5,5,8]
console.log(findMajorityElement(a, 5));
